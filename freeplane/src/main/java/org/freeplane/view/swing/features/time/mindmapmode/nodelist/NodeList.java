...
//		controller = modeController.getController();
	...
	protected void disposeDialog() {
		...
		storage.storeDialogPositions(dialog, getWindowPreferenceStorageProperty());
	...
	private void initializeUI(String mapTitle) {
		...
		final String marshalled = ResourceController.getResourceController().getProperty(
				getWindowPreferenceStorageProperty());
	...
	private String getWindowPreferenceStorageProperty() {
		return  showIcons ? windowPreferenceStorageProperty : windowPreferenceStorageProperty + "WithoutIcons";
	}
	...
	private DefaultTableModel createTableModel() {
		showIcons = ResourceController.getResourceController().getBooleanProperty("nodelist_shows_icons");
		nodeMapColumn = searchInAllMaps ? 0 : -1;
		nodeTextColumn = nodeMapColumn + 1;
		nodeIconColumn = showIcons ? nodeTextColumn + 1 : -1;
		nodeDetailsColumn = showIcons ? nodeIconColumn + 1 : nodeTextColumn + 1;
